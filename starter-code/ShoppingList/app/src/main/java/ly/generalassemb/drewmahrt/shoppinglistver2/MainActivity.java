...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = ShoppingListDatabaseHelper
                .getInstance(MainActivity.this)
                .getAllItems(); //this line might be unnecessary
        ...
        CursorAdapter adapter = new CursorAdapter(MainActivity.this,
            ...
            public View newView(Context context, Cursor cursor, ViewGroup parent) {
                ...
                //am i inflating the right hting?
            }
            ...
            public void bindView(View view, Context context, Cursor cursor) {
                ...
                int index = cursor.getColumnIndex(ShoppingListDatabaseHelper.COL_NAME);
